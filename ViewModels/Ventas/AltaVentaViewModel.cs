...
public class AltaVentaVM : IValidatableObject
{
    ...
    [Range(0, 100, ErrorMessage = "El recargo no puede ser negativo ni mayor al 100%.")]
    ...
    public List<SelectListItem> MetodosDePago { get; set; } // Cambiado para que sea más fácil de usar en la vista.
