...
public class Ventas{
    ...
    public List<DetallesVentas>? Detalles { get; set; }
    ...
    public Ventas() {}
    public Ventas(short idMetodo, decimal total, decimal costo, decimal ganancia, decimal porcentajeGanancia, DateOnly fecha, TimeOnly hora, string? detalle)
    {
        IdMetodo = idMetodo;
        Total = total;
        Costo = costo;
